...
import com.snow.snowaicodemother.model.dto.user.UserAddRequest;
import com.snow.snowaicodemother.model.dto.user.UserLoginRequest;
...
public class UserController {
    ...
    public BaseResponse<Boolean> updateUser(@RequestBody UserUpdateRequest userUpdateRequest) {
        if (Objects.isNull(userUpdateRequest) || userUpdateRequest.getId() == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        User user = new User();
